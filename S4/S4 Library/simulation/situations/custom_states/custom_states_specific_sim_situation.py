...
class SpecificSimCustomStatesSituation(CustomStatesSituation):
    ...
    def get_predefined_guest_list(cls):
        ...
        guest_list.add_guest_info(SituationGuestInfo(filter_result[0].sim_info.sim_id, cls.specific_sim_job, RequestSpawningOption.DONT_CARE, BouncerRequestPriority.EVENT_VIP, expectation_preference=True))
        return guest_list
