...
from sims4.tuning.tunable import TunableMapping, Tunable, TunableReference, TunableVariant, TunableEnumEntry, TunableRange
...
class BaseCustomStatesSituation(SituationComplexCommon):
    ...
    def _save_custom_state(self, writer):
        assert not self._current_state_key is None
