...
OBJECT_CLASSIFICATIONS = ['Objects(Interactive)', 'Objects(Decorative)', 'Objects(Autonomous)', 'Interactions(Autonomous)', 'Objects(UserDirected)']
BUDGETS = {NUM_SIMS: 20, OBJS_ACTIVE_LOT_INTERACTIVE: 350, OBJS_ACTIVE_LOT_DECORATIVE: 250, OBJS_OPEN_STREET_INTERACTIVE: 50, OBJS_OPEN_STREET_DECORATIVE: 250, OBJS_ACTIVE_LOT_AUTONOMOUS_AFFORDANCE: 250, OBJS_TOTAL: 900, POSTURE_GRAPH_NODES: 3000, POSTURE_GRAPH_EDGES: 12000}