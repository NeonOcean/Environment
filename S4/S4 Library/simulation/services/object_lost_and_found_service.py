...
class ObjectLostAndFoundService(Service):
    ...
    class ObjectLocator:
        ...
        def __init__(self, zone_id, open_street_id, object_id, sim_id, household_id):
    ...
    def load(self, **_):
        ...
        for object_locators in object_lost_and_found.locators:
            ...
            locator = self._raw_add_object_data(object_locators.zone_id, object_locators.open_street_id, object_data.object_id, object_locators.sim_id, object_locators.household_id)
        ...
        for locator in list(self._object_locators):
            if locator.zone_id != current_zone_id:
                if locator.open_street_id != current_open_street_id:
                    self._return_lost_object(locator)
    ...
    def _raw_add_object_data(self, zone_id, open_street_id, object_id, sim_id, household_id):
        locator = ObjectLostAndFoundService.ObjectLocator(zone_id, open_street_id, object_id, sim_id, household_id)
        self._object_locators.append(locator)
        return locator

    def add_game_object(self, zone_id, object_id, sim_id, household_id):
        self.remove_clone_id(object_id)
        self.remove_object(object_id)
        return self._raw_add_object_data(zone_id, ObjectLostAndFoundService.STREET_UNKNOWN, object_id, sim_id, household_id) is not None
