...
class RelationshipBitOnFilteredSims(BaseLootOperation):
    ...
    def _apply_to_subject_and_target(self, subject, target, resolver):
        ...
        filter_service.submit_matching_filter(number_of_sims_to_find=self._filter_settings.desired_sim_count, sim_filter=self._filter_settings.sim_filter, callback=filter_callback, blacklist_sim_ids={subject.id})
