...
from sims4.tuning.tunable import HasTunableFactory, OptionalTunable, TunableAngle, TunableVariant, AutoFactoryInit, HasTunableSingletonFactory, TunableEnumEntry
...
class _PortalRoutingSurfaceSpecified(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def __call__(self, obj):
        routing_surface = obj.routing_surface
        return SurfaceIdentifier(routing_surface.primary_id, routing_surface.secondary_id, self.surface_type)
