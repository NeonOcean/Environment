...
from objects.components import Component, ComponentPriority, types
from objects.components.state import ObjectStateValue, StateComponent, TunableStateValueReference
...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableFactory, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableList, TunableMapping, TunablePackSafeReference, TunableReference, TunableSet, TunableTuple
...
class RetailComponent(Component, HasTunableFactory, AutoFactoryInit, component_name = types.RETAIL_COMPONENT, persistence_priority = ComponentPriority.PRIORITY_RETAIL, persistence_key = SimObjectAttributes_pb2.PersistenceMaster.PersistableData.RetailComponent):
	FACTORY_TUNABLES = {
		'sellable': OptionalTunable(description = '\n            If enabled, this object can be sold on a retail lot.\n            ', disabled_name = 'Not_For_Sale', enabled_by_default = True,
