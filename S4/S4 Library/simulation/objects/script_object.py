...
from animation.animation_element import TunableAnimationOverrides, TunableAnimationObjectOverrides
...
class ScriptObject(BaseObject, HasStatisticComponent, HasFootprintComponent, metaclass=HashedTunedInstanceMetaclass, manager=services.definition_manager()):
    ...
    def update_component_commodity_flags(self):
    ...
    def is_persistable(self):
        ...
        if self.persistence_group == objects.persistence_groups.PersistenceGroups.IN_OPEN_STREET:
            ...
            if self.item_location == ItemLocation.ON_LOT or self.item_location == ItemLocation.FROM_OPEN_STREET or self.item_location == ItemLocation.FROM_CONDITIONAL_LAYER:
                return self._persists
            elif self.item_location == ItemLocation.INVALID_LOCATION:
