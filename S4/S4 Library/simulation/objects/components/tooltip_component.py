...
from objects.components import Component, componentmethod, componentmethod_with_fallback, types
from objects.hovertip import HovertipStyle, TooltipFieldConcatenationType, TooltipFields, TooltipFieldsComplete
from protocolbuffers import UI_pb2 as ui_protocols
from sims4.localization import ConcatenationStyle, LocalizationHelperTuning, TunableLocalizedStringFactoryVariant
from sims4.math import Threshold
from sims4.resources import CompoundTypes
from sims4.tuning.tunable import AutoFactoryInit, HasTunableFactory, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableList, TunableMapping, TunableReference, TunableResourceKey, TunableTuple
...
class TooltipComponent(Component, TooltipProvidingComponentMixin, HasTunableFactory, AutoFactoryInit, component_name = types.TOOLTIP_COMPONENT):
	FACTORY_TUNABLES = {
		...
		'state_value_strings': TunableList(
