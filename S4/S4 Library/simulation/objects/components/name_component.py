...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableList, TunableReference, TunableTuple
...
class NameTransfer(XevtTriggeredElement, HasTunableFactory, AutoFactoryInit):
	FACTORY_TUNABLES = {
		'description': 'Transfer name between two participants at the beginning/end of an interaction or on XEvent.',
