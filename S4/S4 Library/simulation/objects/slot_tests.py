...
from objects.object_tests import ObjectTagFactory, ObjectTypeFactory
from objects.slots import RuntimeSlot, SlotType
from sims4.tuning.tunable import AutoFactoryInit, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableList, TunableSingletonFactory, TunableTuple, TunableVariant
...
class SlotTest(HasTunableSingletonFactory, AutoFactoryInit, event_testing.test_base.BaseTest):
	...
	TEST_USED_SLOT = 2
	FACTORY_TUNABLES = {
		'description': 'Verify slot status.  This test will only apply for single entity participants',
		'participant': TunableEnumEntry(description = '\n            The subject of this situation data test.', tunable_type = ParticipantType, default = ParticipantType.Object),
