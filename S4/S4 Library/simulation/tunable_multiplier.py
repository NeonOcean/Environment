...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableFactory, TunableList, TunablePackSafeReference, TunableRange, TunableTuple, TunableVariant

class TestedSum(HasTunableSingletonFactory, AutoFactoryInit):
	FACTORY_TUNABLES = {
		'base_value': Tunable(description = '\n            The basic value to return if no modifiers are applied.\n            ', default = 0, tunable_type = float),
