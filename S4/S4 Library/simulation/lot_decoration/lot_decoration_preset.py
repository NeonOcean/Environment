...
class LotDecorationPreset(HasTunableReference, get_display_mixin(has_icon=True, has_description=True, has_tooltip=True, export_modes=ExportModes.All), metaclass=HashedTunedInstanceMetaclass, manager=services.get_instance_manager(sims4.resources.Types.LOT_DECORATION_PRESET)):
