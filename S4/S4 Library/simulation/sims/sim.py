...
class Sim(HasSimInfoMixin, LockoutMixin, EnvironmentScoreMixin, GameObject):
    ...
    def validate_location(self, location):
        ...
        if routing_location.routing_surface.type == routing.SurfaceType.SURFACETYPE_POOL:
            if not build_buy.is_location_pool(location.transform.translation, location.level) and (wading_interval is None or water_depth <= wading_interval.upper_bound):
                return False
