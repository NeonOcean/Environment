...
from animation.animation_utils import AnimationOverrides, AsmAutoExitInfo, flush_all_animations
...
from interactions import constraints, priority
...
from objects import ALL_HIDDEN_REASONS, HiddenReasonFlag, VisibilityState
from objects.base_interactions import AskToJoinInteraction, JoinInteraction
...
from sims4.callback_utils import CallableList, RemovableCallableList, consume_exceptions
from sims4.geometry import test_point_in_polygon
from sims4.localization import TunableLocalizedString
from sims4.math import Transform
from sims4.tuning.instances import lock_instance_tunables
from sims4.tuning.tunable import OptionalTunable, Tunable, TunableList, TunableMapping, TunableReference, TunableThreshold
...
class Sim(HasSimInfoMixin, LockoutMixin, EnvironmentScoreMixin, GameObject):
	INSTANCE_TUNABLES = {
		'_interaction_queue': InteractionQueue.TunableFactory(tuning_group = GroupNames.COMPONENTS),
	...
	def _anim_overrides_internal (self):
		...
		params = {
			'sex': self.gender.animation_gender_param,
	...
	def _update_face_and_posture_gen (self, timeline):
		...
		try:
			...
			self.posture_state = PostureState(self, None, origin_posture_spec, {
