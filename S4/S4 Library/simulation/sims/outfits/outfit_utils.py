...
from sims.outfits.outfit_enums import BodyType, BodyTypeFlag, CLOTHING_BODY_TYPES, MatchNotFoundPolicy, OutfitCategory, OutfitFilterFlag
...
class OutfitGeneratorRandomizationMixin:
	INSTANCE_TUNABLES = {
		'filter_flag': TunableEnumFlags(description = '\n            Define how to handle part randomization for the generated outfit.\n            ', enum_type = OutfitFilterFlag, default = OutfitFilterFlag.USE_EXISTING_IF_APPROPRIATE | OutfitFilterFlag.USE_VALID_FOR_LIVE_RANDOM, allow_no_flags = True),
