...
class ShutOffUtilityModifier(HasTunableFactory, AutoFactoryInit):
    ...
    def start(self, target):
        if target.get_household_owner_id():
            utilities_manager = services.utilities_manager(target.get_household_owner_id())
