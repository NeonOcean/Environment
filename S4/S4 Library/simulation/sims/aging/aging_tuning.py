...
from sims4.tuning.tunable import Tunable, TunableEnumEntry, TunableMapping, TunableSimMinute
...
class AgingTuning:
	AGING_DATA = TunableMapping(description = '\n        On a per-species level, define all age-related data.\n        ', key_type = TunableEnumEntry(description = '\n            The species this aging data applies to.\n            ', tunable_type = Species, default = Species.HUMAN, binary_type = EnumBinaryExportType.EnumUint32), value_type = AgingData.TunableFactory(), tuple_name = 'AgingDataMapping')
