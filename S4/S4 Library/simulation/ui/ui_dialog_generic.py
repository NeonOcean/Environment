...
from ui.ui_dialog import ButtonType, UiDialog, UiDialogOk, UiDialogOkCancel
...
class UiDialogTextInput(UiDialog):
	FACTORY_TUNABLES = {
		'text_inputs': lambda *names: TunableTuple(**{ name: UiTextInput.TunableFactory(locked_args = {
			'sort_order': index
