...
from sims4.tuning.tunable import OptionalTunable, TunableList, TunableReference, TunableTuple
	...
	FACTORY_TUNABLES = {
		'pickers': TunableList(
			...
			tunable = TunableTuple(description = '\n            \n                ',
								   picker_interaction = TunableReference(
									   description = '\n                    The interaction that will be used to generate a picker.\n                    ',
									   manager = services.get_instance_manager(sims4.resources.Types.INTERACTION),
									   pack_safe = True),
								   disabled_tooltip = TunableLocalizedString(
