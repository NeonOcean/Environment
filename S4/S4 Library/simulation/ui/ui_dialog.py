...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableFactory, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableEnumFlags, TunableFactory, TunableList, TunableSimMinute, TunableTuple, TunableVariant
...
def get_defualt_ui_dialog_response (**kwargs):
	return UiDialogResponse.TunableFactory(locked_args = {
		'sort_order': 0,
		'dialog_response_id': ButtonType.DIALOG_RESPONSE_NO_RESPONSE
	}, **kwargs)
		...
		'response_command': OptionalTunable(description = '\n            If enabled, specifies a command to be called by the client.\n            ', tunable = TunableTuple(command = Tunable(description = '\n                    The command.\n                    ', tunable_type = str, default = ''),
																																											arguments = TunableList(description = '\n                    The arguments for this command. Arguments will be added after the\n                    command.\n                    ',
																																																	tunable = TunableVariant(description = '\n                        An argument being passed to the command.\n                        ',
																																																							 ...
																																																							 integer = TunableTuple(description = '\n                            An integer number.\n                            ', arg_value = Tunable(tunable_type = int, default = 0),
																																																													locked_args = {
																																																														'arg_type': CommandArgType.ARG_TYPE_INT
																																																													}), special_command_data = TunableTuple(
...
class UiDialogOk(UiDialog):
	FACTORY_TUNABLES = {
		'text_ok': TunableLocalizedStringFactory(description = '\n            The OK button text.\n            ', default = 3648501874),
...
class UiDialogOkCancel(UiDialogOk):
	FACTORY_TUNABLES = {
		'text_cancel': TunableLocalizedStringFactory(description = '\n            The Cancel button text.\n            ', default = 3497542682)
	}
