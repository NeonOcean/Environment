...
class RecipePickerRow(BasePickerRow):
    ...
    def __init__(self, price=0, skill_level=0, linked_recipe=None, display_name=DEFAULT, ingredients=None, price_with_ingredients=0, mtx_id=None, discounted_price=0, is_discounted=False, bucks_costs=None, subrow_sort_id=0, **kwargs):
