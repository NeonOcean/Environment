...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableEnumFlags, TunableEnumSet, TunableList, TunableRange, TunableReference, TunableResourceKey, TunableSet, TunableTuple, TunableVariant
...
class UiDialogObjectPicker(UiDialogOkCancel):
	...
	class _MaxSelectableStatic(HasTunableSingletonFactory, AutoFactoryInit):
		...
		def get_max_selectable (self, picker, resolver):
			...
			elif max_selectable == 1 and any(row.is_selected for row in picker.picker_rows):
