...
from sims4.tuning.tunable import OptionalTunable, Tunable, TunableEnumEntry, TunableInterval, TunableList, TunableReference, TunableSimMinute, TunableTuple
...
class TunedContinuousStatistic(statistics.continuous_statistic.ContinuousStatistic):
	...
	INSTANCE_TUNABLES = {
		'decay_rate': sims4.tuning.tunable.TunableRange(description = '\n            The decay rate for this stat (per sim minute).\n            ', tunable_type = float, default = 0.001, minimum = 0.0, tuning_group = GroupNames.CORE),
