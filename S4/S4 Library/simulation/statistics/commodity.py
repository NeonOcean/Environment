...
from sims4.math import EPSILON, Threshold
...
class Commodity(HasTunableReference, TunedContinuousStatistic, metaclass = HashedTunedInstanceMetaclass, manager = services.get_instance_manager(sims4.resources.Types.STATISTIC)):
	...
	INSTANCE_TUNABLES = {
		...
		'stat_name_overrides': TunableMapping(description = '\n                A mapping of Traits to TunableLocalizedString, used to\n                override the stat name field.\n                ', key_type = TunableReference(description = '\n                    The trait.\n                    ', manager = services.get_instance_manager(sims4.resources.Types.TRAIT), pack_safe = True), value_type = TunableLocalizedString(description = '\n                    Localized name of this commodity.\n                    ', allow_none = True), tuple_name = 'StatNameOverrideMapping', export_modes = ExportModes.ClientBinary),
		'min_value_tuning': Tunable(description = '\n                The minimum value for this stat.\n                ', tunable_type = float, default = -100, export_modes = ExportModes.All),
		'max_value_tuning': Tunable(description = '\n                The maximum value for this stat.', tunable_type = float, default = 100, export_modes = ExportModes.All),
		'best_value_tuning': TunableVariant(description = '\n            When creating clones or using the cheat to set all motives to\n            their best value, the max_value_tuning may not be the BEST\n            value, so this is a place to specify what the BEST value is\n            for this commodity.', same_as_max_value_tuning = TunableTuple(locked_args = {
			'best_value_tuning_method': CommodityBestValueTuningMethod.USE_MAX_VALUE_TUNING
		}), same_as_min_value_tuning = TunableTuple(locked_args = {
			'best_value_tuning_method': CommodityBestValueTuningMethod.USE_MIN_VALUE_TUNING
		}), default = 'same_as_max_value_tuning'),
		'ui_render_style': TunableEnumEntry(description = '\n                The render style for this commodity. For example, the powers\n                bar for Vampires have a different render style.\n                ', tunable_type = MotiveUIStyle, default = MotiveUIStyle.DEFAULT, export_modes = ExportModes.All),
		...
		'_off_lot_simulation': TunableVariant(description = '\n                If enabled, this commodity will decay off-lot for the chosen\n                Sim type(s).  This does not apply to babies as their\n                commodities are always auto-satisfied.\n                ', locked_args = {
			'selectable_sims': OFF_LOT_SIM_SELECTABLE,
			'selectable_sims_and_npcs': OFF_LOT_SIM_ALL,
			'disabled': OFF_LOT_SIM_DISABLED
		}, default = 'disabled'),
		'_time_passage_fixup_type': TunableEnumEntry(
			...
			tunable_type = CommodityTimePassageFixupType, default = CommodityTimePassageFixupType.DO_NOT_FIXUP),
		...
		'stat_asm_param': TunableStatAsmParam.TunableFactory(locked_args = {
