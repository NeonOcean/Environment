...
from sims4.tuning.tunable import OptionalTunable, Tunable, TunableEnumEntry, TunableList, TunableRange, TunableReference, TunableTuple
...
class BucksPerk(metaclass = TunedInstanceMetaclass, manager = services.get_instance_manager(sims4.resources.Types.BUCKS_PERK)):
	INSTANCE_TUNABLES = {
		'associated_bucks_type': TunableEnumEntry(description = '\n            The type of Bucks required to unlock this Perk.\n            ', tunable_type = BucksType, default = BucksType.INVALID, pack_safe = True, invalid_enums = (BucksType.INVALID,)),
