...
class SecretLabZoneDirector(RegisterTestEventMixin, SchedulingZoneDirectorMixin, ZoneDirectorBase):
    ...
    def __init__(self):
        ...
        self._command_handlers = {SecretLabCommand.RevealNextSection: self._reveal_next_section, SecretLabCommand.RevealAllSections: self._reveal_all_sections, SecretLabCommand.ResetLab: self._reset_all_sections}
