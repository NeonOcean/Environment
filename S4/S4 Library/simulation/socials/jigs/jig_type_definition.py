...
class SocialJigFromDefinition(AutoFactoryInit, HasTunableSingletonFactory):
    ...
    def get_transforms_gen(self, actor, target, actor_slot_index=0, target_slot_index=1, stay_outside=False, fallback_routing_surface=None, **kwargs):
        (actor_transform, target_transform, routing_surface) = fgl_and_get_two_person_transforms_for_jig(self.jig_definition, actor, actor_slot_index, target, target_slot_index, stay_outside, fallback_routing_surface=fallback_routing_surface)
