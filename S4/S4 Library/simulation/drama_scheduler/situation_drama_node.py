...
from drama_scheduler.drama_node import BaseDramaNode, DramaNodeParticipantOption, DramaNodeUiDisplayType
from drama_scheduler.drama_node_types import DramaNodeType
from event_testing.resolver import DoubleSimResolver
from event_testing.results import TestResult
from interactions import ParticipantTypeSingleSim
from sims4.tuning.tunable import TunableReference, OptionalTunable, Tunable, TunableEnumEntry, TunablePackSafeLotDescription
...
class SituationDramaNode(BaseDramaNode):
    ...
    def _run_situation(self):
        ...
        situation_id = services.get_zone_situation_manager().create_situation(self.situation_to_run, guest_list=guest_list, spawn_sims_during_zone_spin_up=self.spawn_sims_during_zone_spin_up, user_facing=False, zone_id=zone_id)
