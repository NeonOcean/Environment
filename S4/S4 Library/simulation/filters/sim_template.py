...
from sims4.tuning.tunable import TunableEnumEntry, TunableList, TunableTuple, Tunable, TunableReference, TunableSet, HasTunableReference, OptionalTunable, TunableResourceKey, TunableFactory, TunableInterval, AutoFactoryInit, HasTunableSingletonFactory, TunableVariant, TunablePackSafeReference, TunableRange
    ...
    def _add_traits(cls, sim_info, sim_creator=None):
        ...
        if cls._traits.num_random:
            ...
            if num_to_add > 0:
                ...
                available_trait_types = {trait for trait in trait_manager.types.values() if trait.is_personality_trait if not sim_info.has_trait(trait)}
    ...
    def add_perks(cls, sim_info, sim_creator=None):
        ...
        if cls._perks.num_random:
            ...
            if num_to_add > 0:
                ...
                available_bucks_perk_types = {perk for perk in bucks_perk_manager.types.values() if not bucks_tracker.is_perk_unlocked(perk) if cls._perks.whiteblacklist.test_item(perk)}
