...
class ObjectRewardsOperation(BaseLootOperation):
    ...
    def _place_object(self, created_object, resolver=None, subject=None, placement_override_func=None):
        ...
        if not self._force_family_inventory:
            ...
            if instanced_sim is not None and instanced_sim.inventory_component.can_add(created_object) and instanced_sim.inventory_component.player_try_add_object(created_object, hidden=self._needs_compositing):
                return
