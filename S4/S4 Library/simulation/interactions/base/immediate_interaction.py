...
from crafting.photography import CreatePhotoMemory
...
lock_instance_tunables(ImmediateSuperInteraction,
					   ...
					   subaction_selection_weight = 1, relationship_scoring = False,
