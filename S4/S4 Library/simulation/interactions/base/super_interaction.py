...
from interactions.base.interaction import Interaction, OWNS_POSTURE_LIABILITY, CANCEL_AOP_LIABILITY, CancelAOPLiability, OwnsPostureLiability, CancelInteractionsOnExitLiability, CANCEL_INTERACTION_ON_EXIT_LIABILITY, InteractionQueuePreparationStatus, CancelGroupInteractionType
