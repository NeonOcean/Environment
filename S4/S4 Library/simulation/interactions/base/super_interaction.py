...
from interactions.base.interaction import CANCEL_AOP_LIABILITY, CANCEL_INTERACTION_ON_EXIT_LIABILITY, CancelAOPLiability, CancelGroupInteractionType, CancelInteractionsOnExitLiability, Interaction, InteractionQueuePreparationStatus, OWNS_POSTURE_LIABILITY, OwnsPostureLiability
...
class SuperInteraction(RouteEventProviderMixin, Interaction, StageControllerElement):
	...
	def acquire_posture_ownership (self, posture):
		if posture.target is None and posture.mobile:
			return
