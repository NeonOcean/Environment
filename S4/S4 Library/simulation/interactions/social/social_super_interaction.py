...
from interactions import ParticipantType, ParticipantTypeActorTargetSim, ParticipantTypeSingle, PipelineProgress, TargetType
from interactions.base.basic import FlexibleLengthContent, StagingContent
...
from sims4.tuning.tunable import OptionalTunable, Tunable, TunableEnumEntry, TunableMapping, TunableRange, TunableReference, TunableTuple, TunableVariant
...
class SocialSuperInteraction(SocialInteractionMixin, SocialCompatibilityMixin, SuperInteraction):
	...
	INSTANCE_TUNABLES = {
		...
		'outcome': TunableOutcome(allow_social_animation = True, allow_route_events = True, tuning_group = GroupNames.CORE),
