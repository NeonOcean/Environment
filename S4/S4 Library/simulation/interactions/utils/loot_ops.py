...
from objects.components.portal_locking_enums import ClearLock, LockPriority, LockType
from objects.components.state import TunableStateValueReference
from objects.slot_strategy import SlotStrategyVariant
from protocolbuffers import Consts_pb2, DistributorOps_pb2, UI_pb2
...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableSingletonFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableEnumSet, TunableFactory, TunableList, TunablePackSafeReference, TunableRange, TunableRealSecond, TunableReference, TunableTuple, TunableVariant
from traits.trait_type import TraitType
from tunable_multiplier import TunableMultiplier
from ui.notebook_tuning import NotebookSubCategories
from ui.ui_dialog import CommandArgType, UiDialogOk
...
class LifeExtensionLootOp(BaseLootOperation):
	class RestoreDaysFromAgingProgress(HasTunableSingletonFactory, AutoFactoryInit):
		FACTORY_TUNABLES = {
			'days_to_restore': TunableRange(tunable_type = int, default = 0, minimum = 0)
		}
	...
	class AddDaysToAgingProgress(HasTunableSingletonFactory, AutoFactoryInit):
		FACTORY_TUNABLES = {
			'days_to_add': TunableRange(tunable_type = int, default = 0, minimum = 0)
		}
...
class RemoveTraitLootOp(BaseLootOperation):
	...
	class _RemoveSpecificTrait(_BaseRemoveTrait):
		FACTORY_TUNABLES = {
			'specific_trait': TunablePackSafeReference(description = '\n                The trait to be removed.\n                ', manager = services.get_instance_manager(sims4.resources.Types.TRAIT))
		}
	...
	class _RemoveRandomTrait(_BaseRemoveTrait):
		FACTORY_TUNABLES = {
			'trait_type': TunableEnumEntry(default = TraitType.PERSONALITY, tunable_type = TraitType, invalid_enums = TraitType.PERSONALITY)
		}
...
class RemoveNotebookEntry(BaseLootOperation):
	FACTORY_TUNABLES = {
		'subcategory_id': TunableEnumEntry(description = '\n            Subcategory type.\n            ', tunable_type = NotebookSubCategories, default = NotebookSubCategories.INVALID, invalid_enums = (NotebookSubCategories.INVALID,)),
