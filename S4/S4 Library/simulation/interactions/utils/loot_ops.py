...
class LifeExtensionLootOp(BaseLootOperation):
    ...
    def _apply_to_subject_and_target(self, subject, target, resolver):
        ...
        if self.days_from_aging_progress > 0:
