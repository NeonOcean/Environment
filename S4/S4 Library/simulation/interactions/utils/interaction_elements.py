...
from element_utils import CleanupType, build_critical_section, build_critical_section_with_finally, build_delayed_element, build_element
from interactions import ParticipantType, ParticipantTypeSavedActor, ParticipantTypeSingle, ParticipantTypeSingleSim
from interactions.utils.destruction_liability import DELETE_OBJECT_LIABILITY, DeleteObjectLiability
...
from sims4.tuning.tunable import AutoFactoryInit, HasTunableFactory, OptionalTunable, Tunable, TunableEnumEntry, TunableRange, TunableRealSecond, TunableReference, TunableSet, TunableSimMinute, TunableTuple, TunableVariant
...
class XevtTriggeredElement(elements.ParentElement, HasTunableFactory, AutoFactoryInit):
	...
	def _register_event_handler (self, element):
		self.__event_handler_handle = self.interaction.animation_context.register_event_handler(self._behavior_event_handler, handler_id = self.xevt_id)
