...
def get_display_mixin(has_description=False, has_icon=False, has_tooltip=False, use_string_tokens=False, export_modes=()):
    ...
    class _HasOptionalDisplayMixin:
        INSTANCE_TUNABLES = {'_display_data': OptionalTunable(description='\n                If enabled, specify display data for this instance.\n                ', tunable=TunableTuple(description="\n                    The instance's display data.\n                    ", export_class_name='OptionalDisplayMixinTunable' if export_to_client else 'TunableTuple', **display_properties), tuning_group=GroupNames.UI, export_modes=export_modes, enabled_name='optional_display_mixin' if export_to_client else 'enabled')}
