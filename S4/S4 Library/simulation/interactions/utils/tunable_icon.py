...
from sims4.tuning.tunable import TunableEnumFlags, TunableFactory, TunablePackSafeResourceKey, TunableResourceKey, TunableVariant
...
class TunableParticipantTypeIconFactory(TunableFactory):
	...
	def __init__ (self, default_participant_type = None, **kwargs):
		super().__init__(
			participant_type = TunableEnumFlags(enum_type = ParticipantType, default = default_participant_type or ParticipantType.Actor),
