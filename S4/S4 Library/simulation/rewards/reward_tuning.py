...
from business.business_reward_tuning import TunableRewardAdditionalCustomerCount, TunableRewardAdditionalEmployeeSlot, TunableRewardAdditionalMarkup
...
from sims4.tuning.tunable import AutoFactoryInit, Tunable, TunableCasPart, TunableEnumEntry, TunableFactory, TunableLiteralOrRandomValue, TunableMagazineCollection, TunableRange, TunableReference, TunableTuple, TunableVariant
...
class TunableBuildBuyMagazineCollectionUnlock(TunableRewardBuildBuyUnlockBase):
	FACTORY_TUNABLES = {
		'magazine_collection': TunableMagazineCollection(description = '\n            Unlock a magazine room to purchase in build/buy.\n            ')
	}
...
class TunableRewardBucks(AutoFactoryInit, TunableRewardBase):
	FACTORY_TUNABLES = {
		'bucks_type': TunableEnumEntry(description = '\n            The type of Bucks to grant.\n            ', tunable_type = BucksType, default = BucksType.INVALID, invalid_enums = (BucksType.INVALID,), pack_safe = True),
