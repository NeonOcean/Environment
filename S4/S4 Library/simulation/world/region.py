...
from sims4.tuning.tunable import HasTunableReference, TunableMapping, TunableRegionDescription, TunableReference, TunableList, Tunable, TunableEnumEntry, TunableTuple, TunableRange
