...
GAMEPLAY_SUPPORTED_APIS = {'native.animation.arb.BoundaryCondition2', 'native.animation.arb.BoundaryCondition.get_required_slots', 'native.animation.arb_get_timing_looping_duration', 'native.animation.arb.BoundaryConditionInfo', 'native.animation.request_result_codes'}
