...
_BLOBSIMFACIALCUSTOMIZATIONDATA_MODIFIER = descriptor.Descriptor(name = 'Modifier', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.Modifier', filename = None, file = DESCRIPTOR, containing_type = None,
                                                                 fields = [
                                                                     descriptor.FieldDescriptor(name = 'key', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.Modifier.key', index = 0, number = 1, type = 4, cpp_type = 4, label = 1, has_default_value = False, default_value = 0, message_type = None, enum_type = None, containing_type = None, is_extension = False, extension_scope = None, options = None),
                                                                     descriptor.FieldDescriptor(name = 'amount', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.Modifier.amount', index = 1, number = 2, type = 2, cpp_type = 6, label = 1, has_default_value = False, default_value = 0, message_type = None, enum_type = None, containing_type = None, is_extension = False, extension_scope = None, options = None)
                                                                 ], extensions = [], nested_types = [], enum_types = [], options = None, is_extendable = False, extension_ranges = [], serialized_start = 308, serialized_end = 347)
_BLOBSIMFACIALCUSTOMIZATIONDATA = descriptor.Descriptor(name = 'BlobSimFacialCustomizationData', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData', filename = None, file = DESCRIPTOR, containing_type = None,
														fields = [descriptor.FieldDescriptor(name = 'sculpts', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.sculpts', index = 0, number = 1, type = 4, cpp_type = 4, label = 3, has_default_value = False, default_value = [], message_type = None, enum_type = None, containing_type = None, is_extension = False, extension_scope = None, options = descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\x10\x01')),
																  descriptor.FieldDescriptor(name = 'face_modifiers', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.face_modifiers', index = 1, number = 2, type = 11, cpp_type = 10, label = 3, has_default_value = False, default_value = [], message_type = None, enum_type = None, containing_type = None, is_extension = False, extension_scope = None, options = None),
																  descriptor.FieldDescriptor(name = 'body_modifiers', full_name = 'EA.Sims4.Persistence.BlobSimFacialCustomizationData.body_modifiers', index = 2, number = 3, type = 11, cpp_type = 10, label = 3, has_default_value = False, default_value = [], message_type = None, enum_type = None, containing_type = None, is_extension = False, extension_scope = None, options = None)],
                                                        extensions = [], nested_types = [_BLOBSIMFACIALCUSTOMIZATIONDATA_MODIFIER], enum_types = [], options = None, is_extendable = False, extension_ranges = [], serialized_start = 79, serialized_end = 347)
